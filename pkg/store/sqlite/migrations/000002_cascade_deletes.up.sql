...
-- 2. Recreate subscriptions with ON DELETE CASCADE
...
-- 3. Recreate matches with ON DELETE CASCADE, restoring stashed data
...
-- 4. Recreate sessions with ON DELETE CASCADE
